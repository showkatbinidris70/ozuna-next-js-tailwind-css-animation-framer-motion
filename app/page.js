...
export default function Home() {
    ...
    return (
        <div> {/* <div className="bg-image-1 bg-no-repeat bg-right bg-auto py-20 md:py-32 lg:py-32 xl:py-52"> */}
            <div className="bg-image-1 bg-no-repeat bg-right bg-auto py-20">
            ...
            <div className="bg-image-2 bg-no-repeat bg-left-bottom bg-auto py-20">
                                        ...
                                        <div class="absolute top-0 left-0 w-full h-full flex items-end opacity-0 hover:opacity-100">
                                            <div class="flex-row pb-5  w-full">
                                                <div className="text-center my-1">
                                                    <Link href="#" className="text-xl text-white font-black bg-[#ffffff34] p-2 rounded">
                                                        Porches now
                                                    </Link>
                                                </div>
                                                <h4 class="text-white font-bold lg:text-lg text-xl xl:text-2xl ps-5">
            ...
            <div className="bg-image-3 bg-no-repeat bg-right bg-auto py-20">
