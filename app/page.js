            ...
            <div className="container mx-auto px-5">
                <div className="md:flex gap-4 items-center justify-between py-32">
                    <div className="w-full md:w-2/5 py-3 md:py-1">
                        ...
                        <div className="my-6">
                            <a href="#" className="bg-[#E7323F] text-white text-xl rounded py-4 px-10">
                                Porches now
                            </a>
                        </div>
                    </div>
                        ...
                        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                            <div className="my-5 md:my-0 w-full">
                                <div class="relative group">
                                    <Image src={ImgMarkGroup1}
                                        className="rounded-2xl"/> {/* <img src="https://images.unsplash.com/photo-1565440707934-c9bacbad2146?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MjB8fGFuaW1hbHxlbnwwfDJ8MHx8&auto=format&fit=crop&w=500&q=80" alt="Photo by Sébastien Goldberg on Unsplash" class="w-full rounded shadow-xl hover:shadow-2xl"/> */}
                                    ...
                                    <div class="absolute top-0 left-0 w-full h-full flex items-end opacity-0 hover:opacity-100">
                                        <div class="flex-row pb-5  w-full">
                                            <h4 class="text-white font-bold lg:text-lg text-xl xl:text-2xl ps-5">OZUNA AURA TOUR T-SHIRT</h4>
                                            <div className="flex justify-between px-5 items-center">
                                                <div>
                                                    <div className="flex gap-3 lg:gap-1 xl:gap-3 py-1">
                                                        ...
                                                        <div className="text-white text-base font-medium">5 Reviews</div>
                                                    </div>
                            ...
                            <div className="my-5 md:my-0 w-full">
                                <div class="relative group">
                                    <Image src={ImgMarkGroup4}
                                        className="rounded-2xl"/> {/* <img src="https://images.unsplash.com/photo-1565440707934-c9bacbad2146?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MjB8fGFuaW1hbHxlbnwwfDJ8MHx8&auto=format&fit=crop&w=500&q=80" alt="Photo by Sébastien Goldberg on Unsplash" class="w-full rounded shadow-xl hover:shadow-2xl"/> */}
                                    <div class="flex justify-center items-center opacity-0 bg-gradient-to-t from-gray-800 via-gray-800 to-opacity-30 group-hover:opacity-50 absolute top-0 left-0 h-full w-full rounded-2xl"></div>
                                    <div class="absolute top-0 left-0 w-full h-full flex items-end opacity-0 hover:opacity-100">
                                        <div class="flex-row pb-5  w-full">
                                            <div className="text-center my-1">
                                                <Link href="#" className="text-xl text-white font-black bg-[#ffffff34] p-2 rounded">Porches now</Link>
                                            </div>
                                            <h4 class="text-white font-bold lg:text-lg text-xl xl:text-2xl ps-5">OZUNA AURA TOUR T-SHIRT</h4>
